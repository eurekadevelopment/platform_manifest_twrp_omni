...
To get started with OMNI/Eureka sources to build TWRP, you'll need to get
familiar with [Git and Repo](https://source.android.com/source/using-repo.html).

To initialize your local repository using the OMNIROM/Eureka trees to build TWRP, use a command like this:

    repo init -u git://github.com/eurekadevelopment/platform_manifest_twrp_omni.git -b twrp-9.0

To initialize a shallow clone, which will save even more space, use a command like this:

    repo init --depth=1 -u git://github.com/eurekadevelopment/platform_manifest_twrp_omni.git -b twrp-9.0
